...
public final class GSRClothConfigScreen {
    ...
    public static Screen create(Screen parent) {
        ...
        ConfigBuilder builder = ConfigBuilder.create()
                ...
                .setTitle(Component.literal("GSR Preferences"))
                .setSavingRunnable(() -> {
                    config.clampAll();
        ...
        ConfigCategory timerHud = builder.getOrCreateCategory(Component.literal("Timer HUD"));
        timerHud.addEntry(gsr$enumDropdown(entry, Component.literal("HUD Look"), GSRHudLookMode.from(config.hudMode), GSRHudLookMode.values(),
                e -> ((GSRHudLookMode) e).getDisplayName(),
                v -> config.hudMode = ((GSRHudLookMode) v).getValue())
                .setDefaultValue(GSRHudLookMode.FULL)
                .setTooltip(Component.literal("Full: always show timer and splits. Condensed: timer always visible; splits only during event window (start, stop, split)."))
                .build());
        timerHud.addEntry(gsr$enumDropdown(entry, Component.literal("Overall Scale"), GSRScaleOption.from(config.hudOverallScale), GSRScaleOption.values(),
                ...
                .build());
        timerHud.addEntry(gsr$enumDropdown(entry, Component.literal("Timer Scale"), GSRScaleOption.from(config.timerScale), GSRScaleOption.values(),
                e -> ((GSRScaleOption) e).getDisplayName(),
                v -> config.timerScale = GSRConfigPlayer.clampOverallScale(((GSRScaleOption) v).getValue()))
                .setDefaultValue(GSRScaleOption.S100)
                .build());
        timerHud.addEntry(entry.startBooleanToggle(Component.literal("Timer on Right"), config.timerHudOnRight)
                .setDefaultValue(true)
                .setSaveConsumer(v -> config.timerHudOnRight = v)
                .build());
        timerHud.addEntry(gsr$visibilityEntry(entry, config));

        ConfigCategory locatorHud = builder.getOrCreateCategory(Component.literal("Locator HUD"));
        locatorHud.addEntry(gsr$visibilityEntry(entry, config));
        locatorHud.addEntry(entry.startBooleanToggle(Component.literal("Compass at Top"), config.locateHudOnTop)
                .setDefaultValue(true)
                .setTooltip(Component.literal("When on, the structure compass bar is at the top of the screen; when off, at the bottom."))
                .setSaveConsumer(v -> config.locateHudOnTop = v)
                .build());
        locatorHud.addEntry(gsr$enumDropdown(entry, Component.literal("Locate Scale"), GSRScaleOption.from(config.locateScale), GSRScaleOption.values(),
                e -> ((GSRScaleOption) e).getDisplayName(),
                v -> config.locateScale = GSRConfigPlayer.clampOverallScale(((GSRScaleOption) v).getValue()))
                .setDefaultValue(GSRScaleOption.S100)
                .build());
        locatorHud.addEntry(gsr$enumDropdown(entry, Component.literal("Minimum Scale Distance"), GSRMaxScaleDistOption.from(config.maxScaleDistance), GSRMaxScaleDistOption.values(),
                ...
                .setTooltip(Component.literal("Distance at which icons reach max scale (closer = larger)."))
                .build());
        locatorHud.addEntry(gsr$enumDropdown(entry, Component.literal("Min Icon Scale"), GSRIconScaleOption.from(config.minIconScale), GSRIconScaleOption.values(),
        ...
        locatorHud.addEntry(gsr$enumDropdown(entry, Component.literal("Fortress Icon"), GSRFortressIconOption.from(config.fortressItem), GSRFortressIconOption.values(),
                ...
                .build());
        locatorHud.addEntry(entry.startDropdownMenu(Component.literal("Fortress Color"), GSRLocatorColorOption.from(config.fortressColor, fortressDefColor),
        ...
        locatorHud.addEntry(gsr$enumDropdown(entry, Component.literal("Bastion Icon"), GSRBastionIconOption.from(config.bastionItem), GSRBastionIconOption.values(),
                ...
                .build());
        locatorHud.addEntry(entry.startDropdownMenu(Component.literal("Bastion Color"), GSRLocatorColorOption.from(config.bastionColor, bastionDefColor),
        ...
        locatorHud.addEntry(gsr$enumDropdown(entry, Component.literal("Stronghold Icon"), GSRStrongholdIconOption.from(config.strongholdItem), GSRStrongholdIconOption.values(),
                ...
                .build());
        locatorHud.addEntry(entry.startDropdownMenu(Component.literal("Stronghold Color"), GSRLocatorColorOption.from(config.strongholdColor, strongholdDefColor),
        ...
        locatorHud.addEntry(gsr$enumDropdown(entry, Component.literal("Wings (Ship) Icon"), GSRShipIconOption.from(config.shipItem), GSRShipIconOption.values(),
                ...
                .build());
        locatorHud.addEntry(entry.startDropdownMenu(Component.literal("Wings (Ship) Color"), GSRLocatorColorOption.from(config.shipColor, shipDefColor),
        ...
        ConfigCategory style = builder.getOrCreateCategory(Component.literal("Styling"));
        style.addEntry(gsr$enumDropdown(entry, Component.literal("HUD Padding"), GSRHudPaddingOption.from(config.hudPadding), GSRHudPaddingOption.values(),
                ...
                .build());
        style.addEntry(gsr$enumDropdown(entry, Component.literal("Row Height"), GSRRowHeightOption.from(config.hudRowHeight), GSRRowHeightOption.values(),
                ...
                .build());
        style.addEntry(gsr$enumDropdown(entry, Component.literal("Split Gap"), GSRSplitGapOption.from(config.hudSplitGap), GSRSplitGapOption.values(),
                ...
                .build());
        style.addEntry(gsr$enumDropdown(entry, Component.literal("Separator Alpha"), GSRSeparatorAlphaOption.from(config.hudSeparatorAlpha), GSRSeparatorAlphaOption.values(),
                ...
                .build());
        style.addEntry(gsr$enumDropdown(entry, Component.literal("Split Show (s)"), GSRSplitShowTicksOption.from(config.splitShowTicks), GSRSplitShowTicksOption.values(),
                ...
                .setTooltip(Component.literal("How long the split list stays visible after a split (seconds)."))
                .build());
        style.addEntry(gsr$enumDropdown(entry, Component.literal("End Show (s)"), GSREndShowTicksOption.from(config.endShowTicks), GSREndShowTicksOption.values(),
                ...
                .setTooltip(Component.literal("How long the HUD stays visible after victory/fail (seconds)."))
                .build());

        ConfigCategory modSettings = builder.getOrCreateCategory(Component.literal("Mod Settings"));
        modSettings.addEntry(entry.startBooleanToggle(Component.literal("Anti-Cheat (Invalidate Run)"), GSRClient.clientWorldConfig.antiCheatEnabled)
                .setDefaultValue(true)
                .setTooltip(Component.literal("When ON (host only): using locators invalidates the run for ranking. When OFF: locator use does not invalidate. Only the host's setting applies; other players' settings are ignored."))
                .setSaveConsumer(v -> {
                ...
                .build());
        modSettings.addEntry(entry.startBooleanToggle(Component.literal("Auto Start"), GSRClient.clientWorldConfig.autoStartEnabled)
                .setDefaultValue(true)
                .setTooltip(Component.literal("When ON (default): run auto-starts on first movement or block break. When OFF: admin must press Start Run to begin."))
                .setSaveConsumer(v -> {
                ...
                .build());
        modSettings.addEntry(entry.startBooleanToggle(Component.literal("Seed Filter"), GSRClient.clientWorldConfig.seedFilterEnabled)
                .setDefaultValue(true)
                .setTooltip(Component.literal("When ON (green, default): random-seed new worlds retry until Overworld+Nether pass. When OFF (red): vanilla random. Typed seeds are never filtered."))
                .setSaveConsumer(v -> {
                ...
                .build());
        modSettings.addEntry(gsr$enumDropdown(entry, Component.literal("Locator Non-Admin Mode"),
                ...
                .setTooltip(Component.literal("When non-admins can use locator bar: Never = disabled. Always = no time gate. 30 min post split = fortress/bastion 30 min after Nether; stronghold 30 min after overworld return (fortress+bastion done); wings 30 min after dragon. Host only."))
                .build());
        modSettings.addEntry(entry.startBooleanToggle(Component.literal("New World Before Run Ends"), config.allowNewWorldBeforeRunEnd)
                .setDefaultValue(false)
                .setTooltip(Component.literal("When ON (host only): allows the New World key to be used before the run has ended. When OFF (default): New World key only works after victory or fail."))
        ...
        keybinds.addEntry(entry.fillKeybindingField(Component.translatable(GSRKeyBindingParameters.TOGGLE_HUD_KEY), GSRKeyBindings.toggleGsrHudKey)
                .setTooltip(Component.literal("Toggle Timer and Locator HUD on/off. Used when Visibility is \"Toggle (V)\"."))
                .build());
        keybinds.addEntry(entry.fillKeybindingField(Component.translatable(GSRKeyBindingParameters.PRESS_TO_SHOW_HUD_KEY), GSRKeyBindings.pressToShowGsrHudKey)
                .setTooltip(Component.literal("Hold to show Timer and Locator HUD. Used when Visibility is Hold."))
                .build());
        keybinds.addEntry(entry.fillKeybindingField(Component.translatable(GSRKeyBindingParameters.OPEN_CONFIG_KEY), GSRKeyBindings.openGsrConfigKey)
                .setTooltip(Component.literal("Hold G and press this key to open GSR Preferences (config)."))
                .build());
        keybinds.addEntry(entry.fillKeybindingField(Component.translatable(GSRKeyBindingParameters.OPEN_OPTIONS_KEY), GSRKeyBindings.openGsrOptionsKey)
                .setTooltip(Component.literal("Opens the GSR run controls screen."))
                .build());
        keybinds.addEntry(entry.fillKeybindingField(Component.translatable(GSRKeyBindingParameters.NEW_WORLD_KEY), GSRKeyBindings.newGsrWorldKey)
                .setTooltip(Component.literal("After victory or fail, starts new run and returns to world list."))
                .build());
    ...
    private static AbstractConfigListEntry<?> gsr$visibilityEntry(ConfigEntryBuilder entry, GSRConfigPlayer config) {
        ...
        return entry.startDropdownMenu(Component.literal("Visibility"), current,
                ...
                .setTooltip(Component.literal("Affects both Timer and Locator HUD. Toggle (V): press to show/hide. Hold (Tab): hold key to show, release to hide with symmetric fade."))
     ...
     */
    private static <E extends Enum<E>> DropdownMenuBuilder<E> gsr$enumDropdown(ConfigEntryBuilder entry, Component title, E current, E[] values,
            java.util.function.Function<E, Component> displayFn,
     ...
     */
    private static <E extends Enum<E>> E gsr$parseEnum(String s, E[] values, java.util.function.Function<E, Component> displayFn) {
